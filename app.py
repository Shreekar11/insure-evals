        ...
        with gr.Tabs():
            ...
            with gr.Tab("ℹ️ About"):
                gr.Markdown(
                    ...
                    "GPT-4o-mini judge checks every claim against ground truth |\n"
                    ...
                    "### Honesty caveats\n"
                    "- **Single judge** (GPT-4o-mini, temperature=0) — no ensemble, no confidence intervals\n"
                    ...
                    "Safety classifier: `meta-llama/llama-guard-3-8b` via OpenRouter | "
